      ...
      if (!consecutive) {
        if (i - runStart >= months) {
          ...
          bonuses.push({
            ...
            // Canonical CRM IDs may be legacy integers or UUID/text values. Preserve the
            // source identity instead of coercing UUIDs to NaN; bonus keys stringify both.
            contact_id:  contact?.id ?? contactIdStr,
