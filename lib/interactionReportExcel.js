...
function addExecutiveDashboard(sheet, report, startRow) {
  ...
  const qualityRows = [
    ...
    ['ידידותי · סוגים נוספים', matrix.friendly.other, TEAL],
  ];
  ...
  mergeAndStyle(sheet, `A${qualityTitleRow + 11}:N${qualityTitleRow + 11}`, 'סוגים נוספים כוללים אירוח שבת וכל סוג קשר שאינו פרונטלי, וידאו או טלפוני.', {
  ...
  mergeAndStyle(sheet, `A${diagramTitleRow + 10}:N${diagramTitleRow + 10}`, `המאגר הכללי הוא נתון הנהלה משוער. הקבוצות האישיות מחושבות מנתוני ה־CRM; קשר תורני אחד לפחות מסווג לקוח כ״אישי תורני״. ${segments.activeWithoutPersonalQuality} לקוחות פעילים טרם סווגו כאישי תורני או ידידותי.`, {
