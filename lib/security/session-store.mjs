...
function camelSession(value) {
  ...
  return {
    ...
    mfaProtected: value.mfa_protected,
    factorFingerprint: value.mfa_factor_fingerprint,
  ...
  return Object.freeze({
    async create(record) {
      await rpc(client, 'app_session_create', {
        ...
        p_mfa_protected: record.mfaProtected,
        p_mfa_factor_fingerprint: record.factorFingerprint,
    ...
    async rotate(oldIdHash, next, reason) {
      return Boolean(await rpc(client, 'app_session_rotate', {
        ...
        p_mfa_protected: next.mfaProtected,
        p_mfa_factor_fingerprint: next.factorFingerprint,
    ...
    async claimRefresh(idHash, expectedEncryptedRefreshToken, refreshLockHash) {
      return Boolean(await rpc(client, 'app_session_refresh_claim', {
        p_session_hash: idHash,
        p_expected_encrypted_refresh_token: expectedEncryptedRefreshToken,
        p_refresh_lock_hash: refreshLockHash,
      }));
    },
