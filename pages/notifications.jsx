...
import { getNotificationsForUser, getNotificationTypeLabel } from '../lib/notificationDemo';
    ...
    <DesktopLayout title="התראות" subtitle="דמו להתראות פנימיות במערכת">
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
          {notifications.map(n => (
            <div key={n.id} style={{ background:n.read?'#fff':'#fffaf5', border:`0.5px solid ${n.priority==='high'?'rgba(224,127,55,0.25)':'rgba(0,0,0,0.08)'}`, borderRight:`4px solid ${n.priority==='high'?'#f39c12':'#6c5ce7'}`, borderRadius:14, padding:'14px 16px', boxShadow:'0 1px 4px rgba(0,0,0,0.04)' }}>
